package tn.cnss.cooperation.entity;
...
/**
 * Entité représentant un dossier de coopération technique ATCT
 * Basé sur le formulaire officiel CNSS "تسوية فترات إلحاق في إطار التعاون الفني"
 */
@Entity
...
public class DossierATCT {
    ...
    private String modePaiement; // TRIMESTRIEL, ANNUEL, MENSUEL, ANTICIPE
    ...
    private String codeRegime; // 500, 510, 515
    ...
    private String statut; // EN_ATTENTE, VALIDE, REJETE, EN_COURS
